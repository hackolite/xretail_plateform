...
flags.DEFINE_integer('max_steps', default=500000, help='maximum number of steps')
...
def main(_):
  ...
  while int(ckpt.step) < (FLAGS.max_steps + 1):
    ...
    print("step :", int(ckpt.step), FLAGS.max_steps)
    # load data
    ...
    if ckpt.step % FLAGS.save_checkpoint_steps == 0:
      ...
      with summary_writer.as_default():
        ...
        tf.summary.scalar('learning_rate ', 0.0001, step=int(ckpt.step))
